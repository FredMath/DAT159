public class Application {
	...
	public static void main(String[] args) throws Exception {
        ...
        CoinbaseTx startTx = new CoinbaseTx("I have all the money", 100, miner.getAddress());
        ...
        CoinbaseTx coinbaseTx = new CoinbaseTx("Shalom!", 100, fred.getAddress());
        ...
        Transaction regTx = miner.createTransaction((miner.getBalance()/5), fred.getAddress());
        ...
        regTx = miner.createTransaction(miner.getBalance()/5, fred.getAddress());
